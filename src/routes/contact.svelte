...
<Navbar />
<div class="m-4">
	<div class="mx-auto flex flex-col items-center justify-center space-y-5">
		<Avatar />
		<div class="flex flex-row space-x-8" id="socials">
...
<style>
	#socials > a > svg {
		@apply w-16 h-16 fill-stone-800 dark:fill-gray-300 transition-colors;
